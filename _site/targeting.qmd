...
This section shows spening per *targeting criteria* used by political parties to reach citizens in the run-up to the `r sets$election_title` for the latest available data.
