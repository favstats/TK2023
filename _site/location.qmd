...
```{r, message=F, warning=F, cache=F, fig.width=15, fig.height=15, dpi = 900, eval = F}
...
# Create the heading for the party
  ...
  # print(
    ggplot(party_data) +
      ...
      theme_void() +
      theme(legend.position = 'bottom') +
      guides(fill = guide_colourbar(title = 'Spent on ads excluding postcodes (€)', barwidth = 10, barheight = 0.5)) +
  # ) +
  geom_point(
    data = withgeo ,
