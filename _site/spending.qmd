...
Dit gedeelte laat de *volledige* en *dagelijkse* uitgaven zien van politieke partijen in de aanloop naar de Tweede Kamerverkiezingen volgens de nieuwste data.
...
In totaal gaven politieke partijen  `r paste0(currency_symbol, scales::comma_format()(sum30$total_spend_formatted))` euro uit en toonden ze `r sum30$total_num_ads` advertenties op Meta gedurende deze periode.
...
In totaal gaven politieke partijen  `r paste0(currency_symbol, scales::comma_format()(sum7$total_spend_formatted))` euro uit en toonden ze `r sum30$total_num_ads` advertenties op Meta gedurende deze periode.
...
In totaal gaven politieke partijen  `r paste0(currency_symbol, scales::comma_format()(sum30_ggl$total_spend_formatted))` euro uit en toonden ze `r sum30$total_num_ads` advertenties op Google gedurende deze periode.
...
In totaal gaven politieke partijen  `r paste0(currency_symbol, scales::comma_format()(sum7_ggl$total_spend_formatted))` euro uit en toonden ze `r sum30$total_num_ads` advertenties op Google gedurende deze periode.
...
## Uitgaven door de tijd heen

Het is mogelijk dat de dagelijkse geschatte uitgaven niet volledig accuraat zijn omdat Google nauwelijks data opslaat van uitgaven onder de €50 euro. Voor een totale schatting van de uitgaven kijk dan naar de grafieken hierboven.
