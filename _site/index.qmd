...
<div id="overlay" onclick="off()">
  <div id="text">
    ...
    <h3>NOTE: THE DASHBOARD MOVED! It has been adopted by the <a href="https://groene.github.io/TK2023/spending.html" target="_blank">De Groene Amsterdammer (click here)</a>!</h2>
    ...
    <p>If you want to know more about Who Targets Me and our work on ad transparency, visit us on <a href="https://www.whotargets.me/" target="_blank">whotargets.me</a>!</p>  </div>
</div>
...
window.onload = function() {
  ...
  if (!popupLastShown || now - popupLastShown > 60*60*100) {  // 60*60*1000 milliseconds = 1 hour
